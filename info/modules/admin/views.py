...
from info import db
from flask import render_template, request, session, redirect, url_for, jsonify, current_app, abort, g

from info.constants import ADMIN_NEWS_PAGE_MAX_COUNT, ADMIN_USER_PAGE_MAX_COUNT, QINIU_DOMIN_PREFIX
...
def news_edit_detail():
    if request.method == "GET":
        ...
        data = {
            "news": news.to_dict(),
            "category_list": category_dict_list
        }
